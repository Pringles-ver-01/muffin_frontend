    ...
    <>
          <tr>
            <td style={{"paddingRight" : "30px"}}>
              ...
              <div className="my_totlabudget_money">{asset[0] && asset[0].totalAsset}원</div>
            </td>
            <td style={{"paddingRight" : "30px"}}>
            ...
            <td style={{"paddingRight" : "30px"}}>
              ...
              <span className="my_totlabudget_money" style={{ "color" : "#ea5455"}}>{asset[0] && asset[0].totalProfit}</span>
